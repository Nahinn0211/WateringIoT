...
const HomeScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <TouchableOpacity style={styles.modalBackground} onPress={closeMenu} activeOpacity={1}>
          <TouchableOpacity activeOpacity={1} style={{ width: menuWidth }}>
            <Animated.View style={[styles.modalContainer, { transform: [{ translateX }], width: menuWidth }]}>
              <FlatList
                data={menuItems}
